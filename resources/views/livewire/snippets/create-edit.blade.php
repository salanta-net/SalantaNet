            ...
            <div class="-mt-16 sm:-mt-24 sm:flex sm:items-end sm:space-x-5">
                <div class="mt-6 sm:flex sm:min-w-0 sm:flex-1 sm:items-center sm:justify-end sm:space-x-6 sm:pb-1">
                    <div class="mt-6 min-w-0 flex-1">
                        <input class="truncate text-2xl font-bold text-gray-900" />
                    </div>
                </div>
            </div>
        </div>
    </div>
    <div class="mt-8 px-4 pb-12 sm:px-6 lg:px-8 space-y-2">
        <div>
            <h2 class="text-sm font-medium text-gray-500">Syntax: <span class="text-sm font-medium text-gray-900">text</span></h2>
        </div>
        <div>
