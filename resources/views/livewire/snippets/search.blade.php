    ...
    <div class="mt-6 flex gap-x-2">
        <div class="min-w-0 flex-1">
            ...
            <div class="relative rounded-md shadow-sm">
                ...
                <input type="search" wire:model="search" class="block w-full rounded-md border-0 py-1.5 pl-10 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-orange-500 sm:text-sm sm:leading-6" placeholder="Search">
            </div>
        </div>
