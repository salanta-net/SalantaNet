...
{{--            </svg>--}}
        ...
        <div class="mx-auto max-w-7xl px-6 py-0 sm:py-32 lg:flex lg:items-center lg:gap-x-10 lg:px-8 lg:py-16">
            <div class="mx-auto max-w-2xl lg:mx-0 lg:flex-auto">
                <h1 class="mt-10 max-w-lg text-4xl font-bold tracking-tight text-orange-500 sm:text-6xl">Guidelines</h1>
            ...
            <div class="hidden lg:block mt-24 sm:mt-24 lg:mt-0 lg:flex-shrink-0 lg:flex-grow">
